"""An example of a generic agent with multibinary action space and dictionary observations."""
...
class Agent(CRLAgent):
    """A simple agent with dictionary observations and multibinary action space."""
