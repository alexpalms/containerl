...
def add_EnvironmentServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('containerl.EnvironmentService', rpc_method_handlers)
...
def add_AgentServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('containerl.AgentService', rpc_method_handlers)
